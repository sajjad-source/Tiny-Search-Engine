...
1. print nothing to stdout, other than logging its progress
...
(The purpose is to avoid overloading our webserver and to avoid causing trouble on any webservers other than the test server.)